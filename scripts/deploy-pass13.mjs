...
let generated="";
try{
  console.log("Kenji Pass 13: dense lead tickets → compact callback rack → callback stage mapping");
  ...
  console.log("Deploying Kenji Overwatch Pass 13…");
  ...
  console.log("Dense UI: four-up lead tickets on wide desktop, 2x2 metadata blocks, compact actions, compact stage-colored callbacks.");
