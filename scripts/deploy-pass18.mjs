...
let generated="";
try{
  console.log("Kenji Pass 18: universal score heat → denser calls → client workspace tabs → quiet header + Kenji wordmark");
  ...
  console.log("Deploying Kenji Overwatch Pass 18…");
  ...
  console.log("UI: 80+ / 90+ flame heat across leads, calls and callbacks; 3-across call tickets; narrower client detail workspace; History/SMS/Email/Calendar/Notes tabs; simplified header.");
  console.log("Branding: /assets/kenji-logo.webp in the sidebar, /assets/EILA-small-chat.jpg for EILA/support identity.");
