...
let generated="";
try{
  console.log("Kenji Pass 12: stage color system → demo cleanup controls → fixed EILA support → Kenji site branding");
  ...
  console.log("Deploying Kenji Overwatch Pass 12…");
  ...
  console.log("Polish: stage-mapped lead cards, demo delete/reset, fixed-height EILA support, KenjiAI site brand lockup.");
  console.log("Demo deletion is browser-scoped and never mutates real CRM lead data.");
