...
let generated="";
try{
  console.log("Kenji Pass 14: normalize campaigns, integrations, ops, EILA, demo, nurture, scale, launch and setup surfaces");
  ...
  console.log("Deploying Kenji Overwatch Pass 14…");
  ...
  console.log("UI: shared compact controls, panel density, KPI tiles and ticket styling across all remaining owner surfaces.");
  console.log("Behavior and runtime plumbing are unchanged.");
