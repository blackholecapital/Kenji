...
let generated="";
try{
  console.log("Kenji Pass 17: repo-owned EILA portrait → Kenji / AI Call Center branding → support identity");
  ...
  console.log("Deploying Kenji Overwatch Pass 17…");
  ...
  console.log("Branding: /assets/EILA-small-chat.jpg now powers sidebar identity, EILA support and Overwatch dashboard chrome.");
  console.log("Sidebar lockup: KENJI / AI CALL CENTER.");
