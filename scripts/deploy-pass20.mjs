...
let generated="";
try{
  console.log("Kenji Pass 20: final auth hierarchy → compact nurture workspace → stage-mapped client detail → legacy UI cleanup");
  ...
  console.log("Deploying Kenji Overwatch Pass 20…");
  ...
  console.log("Auth: large centered Kenji brand, square EILA identity top-left, centered Powered by EILA OS credit.");
  console.log("Nurture: compact 2/3 operations workspace plus sticky 1/3 customer rail with two-across long-term lead tickets.");
  console.log("Calls: selected-client detail inherits exact stage rim/shading; heat stays beside client name.");
  console.log("Cleanup: removed legacy hidden top-bar brand injection and stopped Pass 11 from rewriting current branding.");
  console.log("No provider, queue, D1 schema, secret, routing or shared-repository changes.");
